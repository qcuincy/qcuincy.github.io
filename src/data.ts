...
export const projectsData: Project[] = [
    {
        ...
        description: "This project established a productivity benchmark for Java software developers by analysing 98 projects from GitHub. Using data mining and statistical methods, we fitted Autoregressive Integrated Moving Average (ARIMA) and Random Walk time-series models to measure productivity in lines of code per author per week. Change point analysis was implemented to segment the project lifecycle into initial, midterm, and mature phases, allowing for more granular performance comparison. The result is a set of four highly accurate benchmarks that software teams can use to evaluate their performance against typical productivity trends.",
        links: [
            { url: "https://github.com/lj20127/MDM3_Code4Thought", label: "Source Code" },
            // { url: "https://demo.com", label: "Live Demo" }
        ],
        media: {
            type: "gallery",
            images: [
            ...
            thumbnail: "/projects/benchmarking/long-arima-benchmark.png"
        }
    },
    {
        id: "project-2",
        ...
        year: "2023",
        month: "Aug",
        tags: ["NLP", "HuggingFace", "FastAPI"],
        description: "A wrapper around LLMs to generate domain-specific legal documents based on brief user prompts. Fine-tuned on a dataset of 50k contracts.",
        links: [
            {
              label: "Launch Interactive Demo",
              url: "https://editor.p5js.org/qcuincy/full/VoaIvusJL",
        ...
        media: {
            type: "image",
            thumbnail: "/projects/crowd-behaviour/thumbnail.png"
        }
    },
    {
        id: "project-3",
        ...
        media: {
            ...
            thumbnail: "/projects/visual-embedding/query-1.png"
        }
    },
    {
        id: "project-4",
        ...
        media: {
          ...
          thumbnail: "/projects/solar-panel-dust-detection/query-1.png"
        }
    },
    {
        id: "project-5",
    ...
    },
    {
        ...
        media: {
          ...
          thumbnail: "/projects/scientific-computing/architecture.jpg"
        }
    },
    {
        id: "project-7",
    ...
    },
    {
        ...
        media: {
            ...
            // thumbnail: "https://img.youtube.com/vi/1lBEOiCPW-c/maxresdefault.jpg"
        }
    },
    {
        id: "project-10",
        ...
        media: {
            ...
            thumbnail: "/projects/yaw-optimisation/example-result.png"
        }
    },
    {
        id: "project-11",
        ...
        media: {
            ...
            thumbnail: "/projects/csp-outage-tracker/outages-highlighted.png"
        }
    },
    {
        id: "project-12",
        ...
        media: {
            ...
            thumbnail: "/projects/component-risk-analysis/total-loss-contribution.png"
        }
    },
    {
        ...
        media: {
          ...
          thumbnail: "/projects/fleet-analysis/architecture.png"
        }
      },
];